                    ...
                    <div className="container">
                        ...
                        <div className="row article-row">
                            ...
                            <div className="col-md-8 qa">
                                ...
                                มาถึงคำถามสำคัญ ที่น้อง ๆหลายคนอยากรู้ว่า <strong>คณะพาณิชยศาสตร์และการบัญชี จุฬาลงกรณ์มหาวิทยาลัย เรียนอะไรกัน ? ใช้คะแนนอะไรยื่นรับตรงบ้าง ? มีกี่หลักสูตร ? มีกี่สาขา ? เรียนภาค Inter (BBA) หรือ ภาคไทย ดี ?</strong> วันนี้พี่ตังเม ขอแฉ เอ้ย เล่าอย่างหมดเปลือกเลยค่ะ <br></br>
                                ...
                                <strong className = 'blue'>บัญชีจุฬาฯ มีกี่หลักสูตร ? มีกี่ภาค ?</strong> <br></br>
                                ...
                                แต่ละภาควิชาเนี่ย หินๆทั้งนั้นเลยจ้า ถ้าจะเขียนอย่างละเอียดทุกอัน อ่าน 2 วัน<br></br> คงไม่จบแน่นอน วันนี้พี่จะขอเล่าโดย<strong>ภาพรวมและเจาะเฉพาะภาคการตลาด</strong>ก่อนเนอะ ว่า<br></br>
                                ...
                                <br></br>
                                หลักสูตรบัญชี จุฬาฯ อินเตอร์ หรือที่น้อง ๆเรียกว่า <strong className = 'blue'>BBA Chula</strong> การเรียนการสอนทั้งหมดจะคล้ายกับ <strong>“หลักสูตรบริหารแต่เป็นภาษาอังกฤษ”</strong> แน่นอนว่าจะช่วยเพิ่มทักษะภาษาอังกฤษให้น้อง ๆอย่างมากเลยทีเดียว <br></br>
                                <strong className = 'blue'>คณะคณะพาณิชยศาสตร์และการบัญชี จุฬาฯ ใช้คะแนนอะไรบ้าง ?</strong> <br></br>
                                <strong>คณะคณะพาณิชยศาสตร์และการบัญชี จุฬาฯ รับตรง</strong> (แบบปกติ) ใช้คะแนน <strong>GAT PAT 1 และ PAT 2 (เฉพาะหลักสูตรสถิติ)</strong><br></br>
                                ...
                                สุดท้าย พี่ตังเมคิดว่า พี่ไม่เสียใจเลยที่ได้เรียนคณะนี้ เพราะคณะนี้ได้ “ให้” พี่มากมายเหลือเกิน ทั้งความรู้ เพื่อน อาจารย์ที่รัก และประสบการณ์ที่หาไม่ได้แล้วจากที่อื่น
                                พี่อยากให้น้อง ๆมาเป็นรุ่นน้องของพี่ แล้วน้อง ๆก็จะรู้เองว่า
                                <strong className = 'blue'>“คณะบัญชี จุฬาฯจะมอบสิ่งที่ดี ๆแบบที่พี่ได้รับ ให้กับน้อง ๆด้วยเช่นกัน”</strong><br></br>
                                *ถ้าน้อง ๆ ต้องการ<strong>เพิ่มเกรด</strong>ในห้องเพื่อยื่นรับตรงหรือAdmission หรือ <strong>สอบแข่งขันเข้ามหาวิทยาลัย</strong> เช่น GAT/ PAT / ONET /TU-STAR
                                หรือ<strong>สนามแข่งอินเตอร์</strong> เช่น SAT /GRE/ GED /TOEFL/ CU-TEP/ CU ATT/ TU-GET
                                พี่ๆ CULH ยินดีจัดส่งติวเตอร์คุณภาพ สอนด้วยใจ ไปช่วยติวถึงที่บ้านแบบตัวต่อตัว <strong className = 'blue'>“อดทน ขยัน แล้วเราจะประสบความสำเร็จไปด้วยกัน”</strong> <br></br>
                        ...
                        <div className="col-md-8 qa">
                            ...
                            <div className = 'row'>
                                <div className = 'col-md-8 '>
                                    ...
                                    คือครอบครัวของพี่อยากให้เข้ามาเรียนในกรุงเทพ เลยคิดในหัวว่า เออ ลองดูก็ได้วะ เด็กกรุงเทพมันจะเก่งขนาดไหน สรุป เก่งจริง ๆ
                                    แบบตอนแรกนึกว่าสอบไม่ติดซะแล้ว ก่อนสอบพี่ก็ทำการ <strong>ศึกษาข้อมูล คุณสมบัติที่จะรับ วิชาที่ต้องสอบ ทุกอย่างเลย และพยายามใช้เวลาให้ได้ประโยชน์มากที่สุด</strong>
                                    นั่นคือเรียนพิเศษส่วนตัวนั่นเอง เพราะเป็นการเรียนที่ได้ความรู้มากที่สุด
