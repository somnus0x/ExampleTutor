        ...
        return(
            <div>
                ...
                <div className = 'container'>
                    <div className = 'row '>
                        <div className = 'col-md-4 col-md-offset-4 m-yellow text-center whyus'>
                            <a href = '/#whyus'>ทำไมต้องเรา</a>
                        </div>
                    </div>
                    <div className = 'row '>
                        <div className = 'col-md-4 col-md-offset-4  text-center whyus link-padding'>

                                สามารถอ่านข้อมูลเพิ่มเติมดีๆเกี่ยวกับอนุบาลได้ที่<br></br> <a className = 'article-link' href = '/kindergartenarticle'>วางรากฐานตั้งแต่อนุบาล สู่อนาคตที่มั่นคง</a>
